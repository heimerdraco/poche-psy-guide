        ...
        <div className="max-w-2xl mx-auto py-8">
          <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              {/* Section de réflexion personnelle - Journal intégré */}
              <div className="mb-6">
                <Button
                ...
                >
                  ...
                  {showReflection ? 'Masquer le journal' : 'Écrire dans mon journal'}
                </Button>
                
                {showReflection && (
                  <div className="space-y-3">
                    <p className="text-sm text-gray-600">
                      📝 Vos réflexions seront automatiquement sauvegardées dans votre journal personnel :
                    </p>
                    <Textarea
